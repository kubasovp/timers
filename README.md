...
Проект помогает держать короткие временные сценарии в одном месте: запускать фокус-профили, быстро ставить таймеры из пресетов/истории, создавать одноразовые и повторяющиеся напоминания.

Работает локально, без аккаунтов, облаков и регистраций. Никакие метрики не собираются, никакие данные никуда не отправляются.

## Зачем

Timers заменяет набор отдельных утилит одним инструментом для повседневной работы: фокус, перерывы, бытовые таймеры и регулярные напоминания.
...
- системные уведомления (в планах) и звуковые сигналы;
- базовая история (в планах);
